...
GEM5OPT=~/michael/latest-gem5/gem5/build/X86/gem5.opt
SPEC17CFG=~/michael/gem5/configs/sys-emu/config-files/spec17_config.py
SIMOPTIONS='--fast-forward=10000000 --maxinsts=300000000 --caches --l2cache --l2_size=1024'
 
######################################################################

BENCHMARK="lbm_r"
OUTDIR=~/michael/gem5/configs/sys-emu/l2cache
